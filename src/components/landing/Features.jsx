...
function Card({ card, index }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -4, boxShadow: '0 12px 40px rgba(0,0,0,0.08)', borderColor: 'transparent' }}
      style={{
        background:    '#fff',
    ...
    >
      ...
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 2, background: 'linear-gradient(90deg, #0284C7, #38BDF8)' }} />
